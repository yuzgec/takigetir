...
class HomeController extends Controller
{
    ...
    public function urun($url){
        ...
        if($Detay->id == 60){
            return redirect()->route('urun','samanyolu-bileklik-altin-kaplama-hediye-kampanyasi');
        }
    ...
    public function kaydet(OrderRequest $request){
        ...
        DB::transaction(function () use ($request, $Cart_Id) {
            ...
            $Sms = 'Kaydınız başarıyla oluşturulmuştur.Adres onayı için '.config('settings.telefon2').' nolu telefondan aranacaksınız. Hayırlı günler dileriz.';
