                ...
                <div class="col-lg-7 mb-md-3 mb-lg-0">
                    <div class="row align-items-center">
                        ...
                        <div class="col my-4 my-md-0">
                            <h5 class="font-size-15 ml-4 mb-0 text-white">Bültenimize abone olun. İndirimlerden ilk siz haberdar olun</strong></h5>
                        </div>
                    </div>
                </div>
                <div class="col-lg-5">
                    ...
                    <form class="js-form-message" action="{{ route('mailsubcribes') }}" method="POST">
                        ...
                        <div class="input-group input-group-pill">
                            ...
                            <div class="input-group-append">
                                <button type="submit" class="btn btn-dark btn-sm-wide height-40 py-2 text-white">Kayıt Ol</button>
                            </div>
                        </div>
                    </form>
