                    ...
                    <div class="col-auto">
                        <nav class="navbar navbar-expand u-header__navbar py-0 justify-content-xl-between">
                            <a class="order-1 order-xl-0 navbar-brand u-header__navbar-brand u-header__navbar-brand-center" href="{{ route('home') }}" aria-label="{{ config('app.name') }}">
                                <img src="/frontend/assets/img/logo1.png" alt="{{ config('app.name') }}" class="img-fluid" style="width: 150px">
                            </a>
                                ...
                                @foreach($Product_Categories as $item)
                                    <li class="nav-item hs-has-mega-menu u-header__nav-item d-flex">
                                        <a class="nav-link u-header__nav-link u-header__nav-link-toggle" href="{{ route('kategori', $item->slug) }}">
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 81.67 101.66"><defs><style>.cls-1{fill:#221f1f;}.cls-2{fill:none;}</style></defs><title>Asset 1</title><g id="Layer_2" data-name="Layer 2"><g id="Layer_1-2" data-name="Layer 1"><polygon class="cls-1" points="61.15 9.91 54.99 18.94 44.15 18.94 49.91 9.91 61.15 9.91"/><polygon class="cls-1" points="59.5 4.25 52.77 4.25 55.1 0.59 59.5 4.25"/><polygon class="cls-1" points="45.94 9.91 40.84 17.93 35.72 9.91 45.94 9.91"/><polygon class="cls-1" points="31.75 9.91 37.51 18.94 26.67 18.94 20.52 9.91 31.75 9.91"/><polygon class="cls-2" points="35.65 8.5 40.84 16.63 46.02 8.5 35.65 8.5"/><polygon class="cls-2" points="26.56 0.59 22.17 4.25 28.9 4.25 26.56 0.59"/><polygon class="cls-2" points="20.2 8.5 26.45 17.66 37.46 17.66 31.61 8.5 20.2 8.5"/><polygon class="cls-2" points="59.5 4.25 55.1 0.59 52.77 4.25 59.5 4.25"/><polygon class="cls-2" points="44.2 17.66 55.21 17.66 61.47 8.5 50.05 8.5 44.2 17.66"/><circle class="cls-2" cx="40.84" cy="60.2" r="29.29" transform="translate(-21.13 22.1) rotate(-24.26)"/><path class="cls-1" d="M56.77,23.23a40.83,40.83,0,1,0,24.9,37.6A40.7,40.7,0,0,0,56.77,23.23ZM40.84,89.67A28.85,28.85,0,1,1,69.68,60.83,28.88,28.88,0,0,1,40.84,89.67Z"/><polygon class="cls-1" points="48.73 4.25 51.44 0 30.22 0 32.93 4.25 48.73 4.25"/><polygon class="cls-1" points="26.78 2.12 29.08 5.73 22.45 5.73 26.78 2.12"/></g></g></svg>
                                            {{ $item->title }}
                                        </a>
                                    </li>
                                @endforeach
