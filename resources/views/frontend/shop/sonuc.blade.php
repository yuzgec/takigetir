                ...
                <div class="bg-gray-1 rounded-lg">
                        ...
                        <div class="p-4 mb-4 checkout-table">
                            <div class="border-bottom border-color-1 mb-5">
                                <h3 class="section-title mb-0 pb-2 font-size-25">Kampanya <b>Detayı</b></h3>
                            </div>

                            <h5> Kıymetli Dostumuz;<br>
                                Kampanyamıza başarıyla katıldınız. Adres teyidi ve sipariş onayı için {{ config('settings.telefon2') }} nnumaralı telefondan müşteri temsilcisi arkadaşlarımız mesai saatleri içerisinde sizleri arayacaktır. Lütfen telefonunuzu açınız.
